...
sed -i -e 's/localhost/'"$NODENAME"'/g' $HOME/FlexMPI/controller/rankfiles/rankfile$4
...
$HOME/LIBS/mpich/bin/mpiexec -genvall -f $HOME/FlexMPI/controller/rankfiles/rankfile$4 -np $1 /tmp/jacobi_IO$4 500 10000 0.00001 100 1 70 -cfile $HOME/FlexMPI/configuration_files/corefiles/corefile -policy-malleability-triggered -lbpolicy-counts 15000 100 -ni 100 -ports $2 $3
