...
all:
	...
	$(MPICC) $(CFLAGS) -shared -fPIC -o ./lib/libempi.so ./src/init.o ./src/server.o ./src/process.o ./src/wrapper.o ./src/lbalance.o ./src/monitor_lp.o ./src/monitor.o ./src/scheduler.o ./src/rdata.o ./src/memalloc.o $(MATH)
	make postclean
	@echo "+++MAKE COMPLETE+++"
